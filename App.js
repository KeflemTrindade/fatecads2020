...
import {View, StatusBar, StyleSheet, TextInput, TouchableOpacity, Text, FlatList, Keyboard} from 'react-native';
import firebase from './src/server/FirebaseConnection'
      ...
      <View style={styles.container}>
        ...
        {key.length > 0 && (
                ...
                <TouchableOpacity onPress={cancelEdit}>
                  <Icon name="x-circle" color="#ff0000" size={20} />
                </TouchableOpacity>
          ...
          <View style={styles.containerTask}>
            <TextInput style={styles.input} value={newTask} placeholder="Nova tarefa" underlineColorAndroid="transparent" onChangeText={(task)=>{setNewTask(task)}} ref={inputRef} />
